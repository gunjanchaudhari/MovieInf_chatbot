...
validators = {
    ('booker', 'GET'): {'args': {'required': ['expression'], 'properties': {'expression': {'description': 'Ask, Which movies are now showing?', 'type': 'string'}}}},
}

filters = {
    ('booker', 'GET'): {200: {'headers': None, 'schema': {'type': 'object', 'properties': {'answer': {'type': 'string'}}}}},
}
